...
10-class schema (0->4, 1->6, 2->7, 3->3, 4->5, 5->8, 20->1, 30->2, 50->10, 62->9), then collapsed to five classes with Other(13)
folded into Stable and Unknown(10) excluded (dropped), using the same 10-to-5 map used for the
...
def write_note(df, summ, common, ref_valid_cells, usable, drops, unmapped, include):
    ...
    lines = [
        ...
        + "), with Other(13) folded into Stable and Unknown(10) excluded, then collapsed with the same "
