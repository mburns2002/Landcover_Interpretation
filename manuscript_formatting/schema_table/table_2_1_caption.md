# Table 2.1 caption (OSU thesis format, placed above the table)

**Table 2.1. Ten-class classification schema. Change classes are defined by a transition observed
between the two analysis dates rather than by an end-state land cover.**

Notes: the schema has ten classes, six stable (no-change) and four change (disturbance). Rows are
